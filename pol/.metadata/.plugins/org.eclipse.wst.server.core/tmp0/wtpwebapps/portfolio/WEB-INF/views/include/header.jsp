...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-3" data-genuitec-path="/portfolio/src/main/webapp/WEB-INF/views/include/header.jsp">

	<nav class="navbar navbar-default navbar-fixed-top" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-3" data-genuitec-path="/portfolio/src/main/webapp/WEB-INF/views/include/header.jsp">
		<div class="container">

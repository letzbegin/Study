...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-20" data-genuitec-path="/Javascript/WebContent/DOM/Element/Ex_01.jsp">
<ul data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-20" data-genuitec-path="/Javascript/WebContent/DOM/Element/Ex_01.jsp">
    <li>html</li>
    <li>css</li>

...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-16" data-genuitec-path="/Javascript/WebContent/DOM/Ex_09.jsp">
<ul data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-16" data-genuitec-path="/Javascript/WebContent/DOM/Ex_09.jsp">
	<li>HTML</li>
	<li>CSS</li>
	<li>JavaScript</li>
</ul>

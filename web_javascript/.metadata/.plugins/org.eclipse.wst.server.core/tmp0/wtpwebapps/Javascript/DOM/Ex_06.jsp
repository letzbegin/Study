...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-17" data-genuitec-path="/Javascript/WebContent/DOM/Ex_06.jsp">
<ul data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-17" data-genuitec-path="/Javascript/WebContent/DOM/Ex_06.jsp">
    <li>HTML</li>
    <li>CSS</li>

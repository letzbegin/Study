...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-19" data-genuitec-path="/Javascript/WebContent/DOM/Element/Ex_00.jsp">
<ul data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-19" data-genuitec-path="/Javascript/WebContent/DOM/Element/Ex_00.jsp">
    <li>html</li>
    <li>css</li>

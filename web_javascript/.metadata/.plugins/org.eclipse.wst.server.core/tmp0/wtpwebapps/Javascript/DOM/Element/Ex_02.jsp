...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/Javascript/WebContent/DOM/Element/Ex_02.jsp">
	<ul data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/Javascript/WebContent/DOM/Element/Ex_02.jsp">
		<li>html</li>
		<li>css</li>

...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-6" data-genuitec-path="/Javascript/WebContent/DOM/Ex_00.jsp">
<ul data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-6" data-genuitec-path="/Javascript/WebContent/DOM/Ex_00.jsp">
	<li>HTML</li>
	<li>CSS</li>
	<li>JavaScript</li>
</ul>

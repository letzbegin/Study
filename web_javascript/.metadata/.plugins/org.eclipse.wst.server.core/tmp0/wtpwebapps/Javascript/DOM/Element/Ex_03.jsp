...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-22" data-genuitec-path="/Javascript/WebContent/DOM/Element/Ex_03.jsp">
<ul data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-22" data-genuitec-path="/Javascript/WebContent/DOM/Element/Ex_03.jsp">
    <li>html</li>
    <li>css</li>

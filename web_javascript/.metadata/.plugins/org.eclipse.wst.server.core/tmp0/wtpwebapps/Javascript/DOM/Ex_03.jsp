...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-10" data-genuitec-path="/Javascript/WebContent/DOM/Ex_03.jsp">
<ul data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-10" data-genuitec-path="/Javascript/WebContent/DOM/Ex_03.jsp">
    <li>HTML</li>
    <li>CSS</li>
    <li>JavaScript</li>
</ul>

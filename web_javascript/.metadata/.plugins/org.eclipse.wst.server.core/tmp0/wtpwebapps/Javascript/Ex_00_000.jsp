...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-23" data-genuitec-path="/Javascript/WebContent/Ex_00_000.jsp">

<!-- Html 코드를 내부에 스크립트 코드를 삽입하는 처리방식 
	
	inline 방식이라고 한다
-->
<input type="button" onclick="alert('Hello World')" value="인라인 방식" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-23" data-genuitec-path="/Javascript/WebContent/Ex_00_000.jsp">

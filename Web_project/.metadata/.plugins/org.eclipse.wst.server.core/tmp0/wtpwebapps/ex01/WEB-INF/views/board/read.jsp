...
<!-- Main content -->
<section class="content" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-250" data-genuitec-path="/ex01/src/main/webapp/WEB-INF/views/board/read.jsp">
	<div class="row">
		<!-- left column -->
		<div class="col-md-12">
